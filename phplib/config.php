...
// for weekly reports
$email_from_domain = "just-eat.com";
...
$weekly_providers = array(
    "github" => array(
        ...
        "class" => "GithubHints",
        "options" => array(
            "github_url" => "https://github.je-labs.com/SOC",
        ),
    ),
    "jira" => array(
        ...
        "class"=> "JIRAHints",
        "options" => array(
            "jira_api_url" => "https://jira.just-eat.net/rest/api/2",
            "jira_url" => "https://jira.just-eat.net/",
...
$oncall_providers = array(
    ...
    "pagerduty" => array(
        ...
        "options" => array(
           ...
           // "username" => "nick.walters@just-eat.com",
            //"password" => "xxx",
            // uncomment and define if you use apikeys
             "apikey" => "XXXEnNKL_ydRLDBY5aLXVb2",
        ),
    ),
);
